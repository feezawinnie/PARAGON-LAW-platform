    ...
    <>
      <section className="relative min-h-[320px]">
        <div className="relative h-75 overflow-hidden">
          <div
            className="w-full h-75 opacity-20 bg-cover bg-center"
            style={{
              backgroundImage:
                "linear-gradient(90deg, rgba(11,34,48,0.5), rgba(209,112,77,0.2)), linear-gradient(to bottom, #e8eef2, #0b2230)",
            }}
          />
          <div
            className="absolute inset-0 top-0 left-0 w-full h-75 dark:hidden"
            style={{
              background:
          ...
          />
          <div
            className="absolute inset-0 top-0 left-0 w-full h-75 hidden dark:block"
            style={{
              background:
      ...
      <section className="px-12 py-20 flex flex-col md:flex-row gap-20">
        <div className="md:w-[45%] shrink-0">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-normal leading-tight mb-6">
            Who we are
          </h1>
      ...
      <section className="px-12 pb-24 flex flex-col md:flex-row gap-0">
        <div className="md:w-1/2 border-l-[3px] border-[#D1704D] pl-10 pr-16 py-6">
          <h2 className="font-display text-2xl md:text-3xl font-normal text-[#D1704D] dark:text-white mb-5">
            Our Vision
          </h2>
